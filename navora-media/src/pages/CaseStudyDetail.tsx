    ...
    <div id={`case-study-${caseStudyId}`} className="pt-24 space-y-20 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="p-6 rounded-xl bg-gradient-to-b from-burnt-orange/15 to-transparent border border-burnt-orange/25 space-y-4">
            <h4 className="font-serif text-base font-bold text-soft-beige uppercase tracking-wider">Acquisition Lift Markers</h4>
            
            <div className="space-y-4">
              {study.visualMetrics.map((met, i) => (
                <div key={i} className="space-y-1">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-soft-beige/70 font-serif">{met.label}</span>
