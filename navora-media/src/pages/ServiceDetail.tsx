      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div className="space-y-4">
            <h3 className="font-serif text-2xl font-bold text-soft-beige">Our Tactical Approach</h3>
            <p className="text-sm text-soft-beige/70 leading-relaxed font-light">
          ...
          <div className="space-y-4">
            <h4 className="font-serif text-lg font-bold text-[#FF8C2A]">Engineered Strategies</h4>
          ...
          <div className="space-y-4 bg-white/5 p-6 rounded-2xl border border-warm-gray/10">
            <h4 className="font-serif text-base font-bold text-soft-beige uppercase tracking-wider">Features & Asset Integration Included</h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              {service.features.map((feat, i) => (
                <div key={i} className="flex items-start space-x-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-burnt-orange mt-1.5 flex-shrink-0" />
                  <span className="text-soft-beige/80">{feat}</span>
                </div>
              ))}
            </div>
          </div>
